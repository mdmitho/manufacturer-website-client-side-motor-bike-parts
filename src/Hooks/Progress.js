    ...
    return (
      ...
      >
        ...
        <label htmlFor="">
          ...
          <progress class="progress progress-info h-5 w-96" value="100" max="100"></progress>
        </label>
        <label htmlFor="">
        ...
        <label htmlFor="">
          ...
          <progress class="progress progress-info h-5 w-96" value="95" max="100"></progress>
        </label>
        <label htmlFor="">
        ...
        <label htmlFor="">
          ...
          <progress class="progress progress-info h-5 w-96" value="90" max="100"></progress>
        </label>
        <label htmlFor="">
