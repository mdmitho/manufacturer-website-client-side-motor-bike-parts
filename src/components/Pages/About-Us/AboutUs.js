        ...
        <div className="hero-content flex-col lg:flex-row">
          ...
          <div>
            ...
            <p className="py-6">
              ...
              parts and other accessories.Later on, many bike owners start getting service done
              from local ... rely on the mechanic's expertise in suggesting and replacing the
              parts.
            </p>
